...
//cl_mem b_mem_obj = clCreateBuffer(context, CL_MEM_READ_ONLY, m*n*sizeof(int), NULL, &ret);
...
cl_kernel kernel = clCreateKernel(program, "rowOp",&ret);
...
ret = clEnqueueReadBuffer(command_queue, a_mem_obj, CL_TRUE, 0, m*n*sizeof(int), A, 0, NULL, NULL);
